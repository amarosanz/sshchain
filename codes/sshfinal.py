...
if D > 1 and (D == 1 or M == Mc):
    print("\nTRANSICIÓN DE FASE")
else:
    topo = D > 1 and M > Mc
    if topo:
        print("\nFASE TOPOLÓGICA: {} ESTADO(S) DE BORDE ESPERADO(S)".format(2 if par else 1))
    else:
...
#    print("BULKENERGIES:", bulkenergies)
...
#    print("BULKENERGIES SORTED:", bulkenergies)
